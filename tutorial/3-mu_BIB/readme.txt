...
Marlin reco_sig_only_steer.xml > log_sig_only
...
Marlin reco_sig_and_BIB_steer.xml > log_sig_and_BIB
...
#You can play with the cuts on the maximum chi2 (first argument) and on the number of hits (second argument) to clean your track sample, as example:

root -l
.L compare_sig_and_BIB.C
compare_sig_and_BIB(5,6)

#In this way a maximum chi2/ndof of 5 and a minimum number of 6 hits is required.
